    ...
    <div id="u-c">
        ...
        <div style="background: white;margin-bottom: 0.3rem">
            <div class="c-h-t">
                ...
                <span @click="goPage('/myOrder/0')" class="ltt">查看全部订单</span>
                <img class="dp-rights" src="../../../static/imgs/right.png"/>
            </div>
            <div class="d-d-d">
                <div class="d-l" @click="goPage('/myOrder/1')">
                    <img src="../../../static/imgs/dfk.png" alt=""><br>
                    <span>待付款</span>
                </div>
                <div class="d-l" @click="goPage('/myOrder/2')">
                    <img src="../../../static/imgs/dfh.png" alt=""><br>
                    <span>待发货</span>
                </div>
                <div class="d-l" @click="goPage('/myOrder/3')">
                    <img src="../../../static/imgs/dsh.png" alt=""><br>
                    <span>待收货</span>
                </div>
                <div class="d-l" @click="goPage('/myOrder/6')">
