<template>
  <div class="home-content">
    ...
    <home-list title="新品首发" @handleDetail="handleDetail"></home-list>
    ...
    <div class="productor-container">
      ...
      <div class="productor-content">
        <productor-item v-for="manufacturer in data.manufacturer" :key="manufacturer.mId" :productor="manufacturer" />
      </div>
    </div>
